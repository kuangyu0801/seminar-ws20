...
we have imputed implicitly considered when the methodology does not explicitly mention the type of data, but phases and steps can be applied to it. CDQ attempts an extension to semistructured data of steps and techniques origi- nally developed for structured data.
\begin{table}[]
\centering
\begin{tabular}{|c|c|c|}
\hline
