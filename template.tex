...
In this section, the fundamentals of data and classifications of assessment methods are introduced.
First, concepts and definitions of the data type, data quality problem, and data quality dimensions are presented. Secondly, in classifications assessment methods, the paper discussed the most common process, pipelines for analyzing DQ are introduced.
These topics regarding these methodologies include steps and phases, strategies and techniques, dimensions, costs.
...
In this section, five data quality assessment methods are introduced in brief, summarizing their characteristics and steps. These methods are Total Data Quality Management (TDQM), Total Information Quality Management (TIQM), Data Quality Assessment (DQA), Information Quality Measurement(IQM), and Comprehensive methodology for Data Quality management(CDQ). The detailed comparison will be presented in section Evaluation.
...
\begin{figure}
    \centering
    \includegraphics[width=1\textwidth]{Paper/figures/TDQM-2.png}
    \caption{TDQM Phases.}
...
Furthermore, the economics approach introduces a cost-benefit evaluation to justify data quality interventions.
...
\subsection{Comprehensive Data Quality (CDQ)}
